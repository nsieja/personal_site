...
function pickPlace(place) {
  ...
  fetch(weatherLink)
    ...
    .then(data => {
      ...
      document.getElementById("about").innerHTML = `<p>${homes[place].aboutinfo}</p>`;
    })
    .catch(error => {
